...
def retry_text(
    ...
    "farm_name":
        (
            "உங்க தோட்டத்தோட பேரை "
            "இன்னொரு தடவை தெளிவா சொல்லுங்க."
        ),

    "total_farm_acres":
        (
            "உங்க மொத்த நிலம் "
            "சுமார் எத்தனை ஏக்கர்னு சொல்லுங்க."
        ),

    "banana_area_acres":
        (
            "அதுல எத்தனை ஏக்கர்ல "
            "வாழை போட்டிருக்கீங்கன்னு சொல்லுங்க."
        ),

    "banana_variety":
        (
            "என்ன வகை வாழை போட்டிருக்கீங்கன்னு "
    ...
    "planting_age":
        (
            "வாழை நட்டு சுமார் "
            "எத்தனை மாசம் ஆகுதுன்னு சொல்லுங்க."
        ),

    "approximate_plants":
        (
            "சுமார் எத்தனை வாழை மரம் இருக்குன்னு "
            "சொல்லுங்க. தெரியலன்னா "
            "தெரியாதுன்னு சொல்லலாம்."
        ),
    ...
    "drainage":
        (
            "மழை பெய்ஞ்சா தண்ணி "
            "சீக்கிரம் வெளியேறுதா, "
            "கொஞ்ச நேரம் நிக்குதா, "
            "இல்ல தேங்கி நிக்குதான்னு சொல்லுங்க."
        ),

    "support":
        (
            "வாழைக்கு கம்பு அல்லது ஆதரவு "
            "பெரும்பாலும் இருக்கா, "
            "சில மரங்களுக்கு இருக்கா, "
            "இல்ல ரொம்ப குறைவான்னு சொல்லுங்க."
        ),

    "accessibility":
        (
            "தொழிலாளர்கள் தோட்டத்தோட "
            "எல்லா பக்கமும் சுலபமா "
            "போக முடியுதான்னு சொல்லுங்க."
        ),
        }
       return (
            "மன்னிக்கணும், அது சரியா புரியல. "
            + field_prompts.get(
                field,
